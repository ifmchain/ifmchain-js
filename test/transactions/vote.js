...
describe("vote.js", function () {
    ...
    describe("#createTransaction without second secret", function () {
        ...
        var data = {
            ...
            fee: 1,
            asset: {
                votes: ["+3b3ccba6dc3817eab715479bf2932a4ac44522a3a5cc8c77bf77a84d31b0cc6f", "+188f2ec5fbcf2260da09892057f430c7a9db77e67f0b47e4b3f734014749eee7"]
            }
        }
    ...
    function testTrs(name, trs, data, sender) {
        describe("returned contact transaction " + name, function () {
            ...
            it("should have recipientId as string and to be equal input sender address", function () {
                (trs.recipientId).should.be.type("string").and.equal(sender.address);
